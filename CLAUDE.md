...
| `docs/아키텍처-결정-기록/` | ADR — phase 별 묶음 6 파일 + cross-cutting (왜 이렇게 했는가) |
| `docs/구현-현황.md` | R1~R11 task 별 status + commit + V4/R12+ 이연 (무엇이 완료/미완료인가) |
| `docs/디자인/README.md` | 디자인 폴더 정식 — 6 테마 시안 + 형태 토큰 + 패키징 + 12 스크린샷 sign-off |
| `docs/superpowers/specs/2026-04-18-rolestra-design.md` | 단일 권위 spec (134 KB, 11 phase 누적) |
| `docs/superpowers/plans/2026-04-26-rolestra-phase-r11.md` | R11 진행 plan (1140 lines) |
...
## 핵심 아키텍처 결정 (ADR 요약 — 상세는 `docs/아키텍처-결정-기록/`)
