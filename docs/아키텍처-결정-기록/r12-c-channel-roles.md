...
- R12-C plan: [`docs/superpowers/plans/2026-05-02-rolestra-phase-r12-c.md`](../superpowers/plans/2026-05-02-rolestra-phase-r12-c.md)
- 회의 시스템 재설계 결정 (메모리, R12-C2 P1 spec round 입력): `rolestra-r12-meeting-system-redesign-2026-05-03.md`
- R12-C2 plan: `docs/superpowers/plans/2026-05-03-rolestra-phase-r12-c2.md` (작성 예정)
