...
**Prev plan:** `docs/plans/2026-04-26-rolestra-phase-r11.md`
**Spec:** `docs/specs/2026-04-18-rolestra-design.md`
...
- ADR: `docs/decisions/cross-cutting.md` (C3 ExecutionService + C4 IPC + C5 secrets + C6 path-guard 와 정합)
