...
- Spec:
  ...
  - `docs/checklists/r8-done-checklist.md` (R9 인수인계 6건 중 2건 Task 10 에서 통합)
- R8 plan/done-checklist: `docs/plans/2026-04-23-rolestra-phase-r8.md`, `docs/checklists/r8-done-checklist.md`
- Main 재사용 모듈:
...
- [x] `docs/plans/2026-04-23-rolestra-phase-r9.md.tasks.json` 생성 (14 task slot)
...
- [ ] `docs/checklists/r9-done-checklist.md` 작성:
  - 14 task 산출물 맵
  - 게이트 결과표
