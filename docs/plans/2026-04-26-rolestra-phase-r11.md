...
- 문서:
  ...
  - `docs/decisions/` — phase 별 묶음 ADR (D8)
  - `docs/design/` — `Rolestra_sample/` 이전 + sign-off 마크
- State flow:
  - **Onboarding 자동 진입:**
...
- Spec:
  ...
  - `docs/checklists/r10-done-checklist.md` (Known Concerns 8 건 — 모두 R11 종결)
  - `docs/checklists/r9-done-checklist.md` (D8 Retro 영어 복귀 결정 재논의 항목)
- R10 plan/done-checklist: `docs/plans/2026-04-24-rolestra-phase-r10.md`, `docs/checklists/r10-done-checklist.md`
...
- R11 신규 디렉토리:
  ...
  - `docs/design/` — `Rolestra_sample/` 이전 + sign-off (Task 13)
...
- [ ] `docs/plans/2026-04-26-rolestra-phase-r11.md.tasks.json` 생성 (17 task slot — Task 0 + Task 1~16)
...
- [ ] 12 스크린샷 캡처 (6 테마 × 2 surface — Dashboard + Messenger):
  ...
  - macOS native 빌드
  - `docs/specs/appendix/r10-evidence/screenshots/` 디렉토리에 PNG
...
- [ ] `docs/decisions/` 정리 (D8 — phase 별 묶음 ADR):
...
- [ ] `docs/design/` 신규: `docs/Rolestra_sample/` 의 6 화면 × 6 변형 시안 이전 + sign-off 마크 (12 스크린샷 from Task 4)
...
- [ ] `docs/checklists/r11-done-checklist.md` 작성:
  - 17 task 산출물 맵
...
- 결정: `docs/decisions/` 안에 `R1-R3-decisions.md` 같은 phase 별 묶음 파일 6 개. 개별 ADR 파일 (`ADR-001-IPC-typedInvoke.md` 등) 미채택.
