...
**참고 메모리 / spec**:
- `docs/specs/2026-05-01-rolestra-channel-roles-design.md` (단일 권위 spec)
- `docs/plans/2026-05-01-rolestra-r12-s-persona-skills.md` (R12-S 종결)
...
| `docs/decisions/r12-c-channel-roles.md` | ADR | Create |
| `docs/specs/2026-05-01-rolestra-channel-roles-design.md` | §4 부서 회의 매트릭스 + §11 갱신 + §11.9 SKILL.md 자동 배치 + §11.10 R12-W 신규 | Modify |
...
**Files:**
- Modify: `docs/specs/2026-05-01-rolestra-channel-roles-design.md`
...
**Verify:** `git diff --stat docs/specs/2026-05-01-rolestra-channel-roles-design.md`
...
```bash
git diff --stat docs/specs/2026-05-01-rolestra-channel-roles-design.md
```

Expected: `1 file changed, 100~150 insertions(+), 5~15 deletions(-)`.

```bash
grep -n "부서별 회의 형식 매트릭스\|11.9 SKILL.md\|11.10 R12-W\|11.11 R12-D" docs/specs/2026-05-01-rolestra-channel-roles-design.md
```
...
**Files:**
- Create: `docs/decisions/r12-c-channel-roles.md`
- Modify: `docs/구현-현황.md`
- Modify: `docs/plans/2026-05-02-rolestra-phase-r12-c.md.tasks.json`
