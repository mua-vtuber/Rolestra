...
- Spec:
  - `docs/specs/2026-04-18-rolestra-design.md` §5.2(005_session_state_sessions / 006_session_snapshots / 008_execution_audit), §6(meeting:* + stream:*), §7.5(회의 시스템 상세), §10 Phase R6(Task 0에서 R3~R5 템플릿으로 확장), 부록 A v2→v3 델타
  - `docs/checklists/r5-done-checklist.md` "Known Concerns (R6 인수인계)" 4항
- R5 plan/done-checklist: `docs/plans/2026-04-21-rolestra-phase-r5.md`, `docs/checklists/r5-done-checklist.md`
- v2 engine 자산 (재사용):
...
- [ ] `docs/plans/2026-04-22-rolestra-phase-r6.md.tasks.json` 생성 (14 task slot)
...
- [ ] `docs/checklists/r6-done-checklist.md` 신규 (R5 template 답습):
  - 구현 체크리스트 (Task 0~13)
