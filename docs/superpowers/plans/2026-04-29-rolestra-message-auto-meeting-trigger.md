...
**Goal:** spec `docs/superpowers/specs/2026-04-29-rolestra-message-auto-meeting-trigger-design.md` (commit `d10abe7`) 의 13 결정 항목을 구현 — 모든 채널에서 메시지 송신 시 즉시 응답이 시작되고, 같은 직원이 여러 회의에 동시 참여할 수 있도록.
...
- `docs/superpowers/specs/2026-04-18-rolestra-design.md` — §7.4 / §7.5 / §8 갱신 reference.
- `docs/아키텍처-결정-기록/cross-cutting.md` 또는 신규 `R12-decisions.md` — D-A ADR.
...
**Files:**
- Modify: `docs/superpowers/specs/2026-04-18-rolestra-design.md` (§7.4 / §7.5 / §8 갱신)
- Create or modify: `docs/아키텍처-결정-기록/R12-decisions.md` (또는 cross-cutting.md 추가)
...
`docs/superpowers/specs/2026-04-18-rolestra-design.md` §7.4 "채널 내 회의 시작" 절에:

```markdown
> **D-A (2026-04-29) 갱신**: 명시 [회의 시작] 클릭 모델은 자동 트리거 모델로 대체. 자세한 동작은 `docs/superpowers/specs/2026-04-29-rolestra-message-auto-meeting-trigger-design.md` 참고.
```
...
`docs/아키텍처-결정-기록/R12-decisions.md` 신규 또는 `cross-cutting.md` 에 추가:
...
**참고**: 본 ADR 의 결정 종합은 `docs/superpowers/specs/2026-04-29-rolestra-message-auto-meeting-trigger-design.md` §2 결정 표.
```
...
```bash
git add docs/superpowers/specs/2026-04-18-rolestra-design.md docs/아키텍처-결정-기록/
