...
| `docs/아키텍처-결정-기록/r12-s-persona-skills.md` | ADR | Create |
| `docs/superpowers/specs/2026-05-01-rolestra-channel-roles-design.md` | §3 카탈로그 갱신 (10 능력) | Modify |
...
**Files:**
- Modify: `docs/superpowers/specs/2026-05-01-rolestra-channel-roles-design.md` (§3 "시스템 정의 스킬 카탈로그" 표 + §3 "데이터 모델 변경" 의 roles 예시)
...
**Verify:** `git diff docs/superpowers/specs/2026-05-01-rolestra-channel-roles-design.md | head -150`
...
`docs/superpowers/specs/2026-05-01-rolestra-channel-roles-design.md` 의 line 65~75 부근 표를 다음으로 교체:
...
Run: `git diff --stat docs/superpowers/specs/2026-05-01-rolestra-channel-roles-design.md`
Expected: 1 file changed, 약 30~40 insertions, 약 5~10 deletions.

- [ ] **Step 6: Commit**

```bash
git add docs/superpowers/specs/2026-05-01-rolestra-channel-roles-design.md
...
**Files:**
- Create: `docs/아키텍처-결정-기록/r12-s-persona-skills.md`
...
- spec: `docs/superpowers/specs/2026-05-01-rolestra-channel-roles-design.md` §4
...
```bash
git add docs/아키텍처-결정-기록/r12-s-persona-skills.md \
        docs/구현-현황.md \
...
- 기존 R11 plan format: `docs/superpowers/plans/2026-04-26-rolestra-phase-r11.md`
