...
- Spec:
  ...
  - `docs/superpowers/specs/r7-done-checklist.md` (R8 인수인계 7건 — R8 직접 영향 0, 단 D2 24h timer rehydrate 는 R9 와 함께)
- R7 plan/done-checklist: `docs/superpowers/plans/2026-04-22-rolestra-phase-r7.md`, `docs/superpowers/specs/r7-done-checklist.md`
- Main 재사용 모듈:
...
- [ ] `docs/superpowers/plans/2026-04-23-rolestra-phase-r8.md.tasks.json` 생성 (14 task slot)
...
**목표**: R8 전체 합격선 확인 + `docs/superpowers/specs/r8-done-checklist.md` 작성 + tasks.json 14/14 처리.
...
- [ ] `docs/superpowers/specs/r8-done-checklist.md` 작성:
  - 14 Task 산출물 링크
