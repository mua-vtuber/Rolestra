...
**Plan**: `docs/superpowers/plans/2026-04-22-rolestra-phase-r6.md`
...
- `docs/superpowers/plans/2026-04-22-rolestra-phase-r6.md` + `.tasks.json` (14-slot).
- `docs/superpowers/specs/2026-04-18-rolestra-design.md` §10 R6 블록 확장.
- `docs/superpowers/specs/r6-done-checklist.md` (본 파일).
