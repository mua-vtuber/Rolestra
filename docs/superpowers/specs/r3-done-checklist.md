...
> Plan: `docs/superpowers/plans/2026-04-20-rolestra-phase-r3.md`
...
- `docs/superpowers/specs/appendix-legacy-channels.md` — 27-entry table (channel → caller → R11 replacement).
